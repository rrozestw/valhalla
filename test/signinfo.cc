...
TEST(Signinfo, ExitToTest) {
  ...
  if (signs.size() == 1) {
    EXPECT_EQ(signs[0].type() , Sign::Type::kExitToward) << "I 495 Toward I 270 To I 95 should be a toward.";
    EXPECT_EQ(signs[0].text() , "I 495 Toward I 270 To I 95") << "Exitsign text is bad for I 495 Toward I 270 To I 95";
  } else {
  ...
  if (signs.size() == 1) {
    ...
    EXPECT_EQ(signs[0].text() , "I 495 North") << "Exitsign text is bad for I 495 North destination ref";
  } else {
  ...
  if (signs.size() == 1) {
    ...
    EXPECT_EQ(signs[0].text() , "I 695 North") << "Exitsign text is bad for I 695 North destination to ref";
  } else {
  ...
  if (signs.size() == 1) {
    EXPECT_EQ(signs[0].type() , Sign::Type::kGuideToward) << "I 695 North should be a toward. No exit 5 should exist.";
    EXPECT_TRUE(signs[0].is_route_num()) << "I 695 North should be flagged as a route num";
    EXPECT_EQ(signs[0].text() , "I 695 North") << "Exitsign text is bad for I 695 North destination to ref";
  } else {
