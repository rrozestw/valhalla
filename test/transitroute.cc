...
TEST(TransitRoute, TestWriteRead) {
  ...
  EXPECT_THROW(TransitRoute route(route_type, kMaxNameOffset + 1, 222, 333, 444, 555, 666, 777, 888, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, kMaxNameOffset + 1, 333, 444, 555, 666, 777, 888, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, 222, kMaxNameOffset + 1, 444, 555, 666, 777, 888, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, 222, 333, kMaxNameOffset + 1, 555, 666, 777, 888, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, 222, 333, 444, 555, 666, kMaxNameOffset + 1, 888, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, 222, 333, 444, 555, 666, 777, kMaxNameOffset + 1, 999), std::runtime_error);
  EXPECT_THROW(TransitRoute route(route_type, 111, 222, 333, 444, 555, 666, 777, 888, kMaxNameOffset + 1), std::runtime_error);
}
